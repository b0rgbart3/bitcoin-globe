...
import type { Tx } from "@btcglobe/shared/types";

const MAX_MOTES = 600; // ring buffer; ~4/s * 15s life leaves plenty of room
const LIFE = 14; // seconds a mote lives
const FADE_IN = 0.6;
const FADE_OUT = 4.0;
...
interface Mote {
  born: number;
  pos: THREE.Vector3;
  axis: THREE.Vector3; // slow orbital drift axis (no meaning — just motion)
  speed: number;
  size: number;
  color: THREE.Color;
}
